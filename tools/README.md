...
| [`bootstrap_plan.py`](./bootstrap_plan.py) | **부트스트랩 계획** — 레포 트리에서 skill 17 이 OpenCrab 에 프로비저닝할 정확한 인벤토리(3 프로젝트·빌더 팩 44·빈 뼈대 14)를 결정론적으로 산출. *계획, actuator 아님* | "설치가 레포가 규정한 만큼만 만들었는가?" | [17 부트스트랩](../skills/17-bootstrap.md) |

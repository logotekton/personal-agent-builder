...
트리거는 추상 개념이 아니라 **실제 호스트 훅에 그대로 사상**됩니다. 호스트별 *실가동 배선*
(Claude Code 훅 · **Codex CLI 훅** · OpenAI Agents SDK · 순수 API)과 구체적 설정 예시는
[14 호스트 배선 어댑터](../skills/14-host-binding.md)에 있습니다 — 아래는 요약입니다.
